...
import { PasswordlessLoginAutoVerifyOptionsBag } from "@Obsidian/ViewModels/Blocks/AccountSecurity/Login/passwordlessLoginAutoVerifyOptionsBag";
...
export type LoginInitializationBox = {
    ...
    /** Gets or sets a value indicating whether the client should redirect to the Rock.ViewModels.Blocks.AccountSecurity.Login.LoginInitializationBox.RedirectUrl. */
