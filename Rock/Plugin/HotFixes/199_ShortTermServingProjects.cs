...
namespace Rock.Plugin.HotFixes
{
    ...
    public class ShortTermServingProjects : Migration
    {
        ...
        private void ShortTermServingProjects_AddPublicBlockTypes()
        {
            ...
            RockMigrationHelper.AddOrUpdateBlockTypeAttribute( "74A20402-00DF-4A87-98D1-B5A8920F1D32", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Display Campus Filter", "DisplayCampusFilter", "Display Campus Filter", "Determines if the campus filter should be shown.", 0, "False", "C3589A12-795C-4B98-AB6B-6901886FC728" );
            RockMigrationHelper.AddOrUpdateBlockTypeAttribute( "74A20402-00DF-4A87-98D1-B5A8920F1D32", "59D5A94C-94A0-4630-B80A-BB25697D74C7", "Campus Types", "CampusTypes", "Campus Types", "The types of campuses to include on the campus list.", 0, "", "FFE4F58E-6FE0-4E6E-8CD5-F60294F57189" );
            RockMigrationHelper.AddOrUpdateBlockTypeAttribute( "74A20402-00DF-4A87-98D1-B5A8920F1D32", "59D5A94C-94A0-4630-B80A-BB25697D74C7", "Campus Statuses", "CampusStatuses", "Campus Statuses", "The statuses of the campuses to include on the campus list.", 0, "", "EB976D8F-9382-4B6E-A435-25B040FDD717" );
            ...
            RockMigrationHelper.AddOrUpdateBlockTypeAttribute( "74A20402-00DF-4A87-98D1-B5A8920F1D32", "99B090AA-4D7E-46D8-B393-BF945EA1BA8B", "Display Attribute Filters", "DisplayAttributeFilters", "Display Attribute Filters", "The group attributes that should be available for user to filter results by.", 0, "", "82D4761F-3F36-43EE-95D6-54B5417DBF16" );
            RockMigrationHelper.AddOrUpdateBlockTypeAttribute( "74A20402-00DF-4A87-98D1-B5A8920F1D32", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Display Date Range", "DisplayDateRange", "Display Date Range", "When enabled, individuals would be able to filter the results by projects occurring inside the provided date range.", 0, "False", "B33CF69F-8A0F-4EA1-9625-D6AD8174584E" );
            RockMigrationHelper.AddOrUpdateBlockTypeAttribute( "74A20402-00DF-4A87-98D1-B5A8920F1D32", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Display Location Range Filter", "DisplayLocationRangeFilter", "Display Location Range Filter", "When enabled a filter will be show to limit results to a specified number of miles from the location selected or their mailing address if logged in. If the Location Sort entry is not enabled to be shown and the individual is not logged in then this filter will not be shown, even if enabled, as we will not be able to honor the filter.", 0, "False", "EED92C2B-370B-4EF5-98D3-30F4174053A6" );
            RockMigrationHelper.AddOrUpdateBlockTypeAttribute( "74A20402-00DF-4A87-98D1-B5A8920F1D32", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Display Slots Available Filter", "DisplaySlotsAvailableFilter", "Display Slots Available Filter", @"When enabled allows the individual to find projects with ""at least"" or ""no more than"" the provided spots available.", 0, "False", "6E05D7CD-3D6F-48D0-863D-8D44D4716121" );
            RockMigrationHelper.AddOrUpdateBlockTypeAttribute( "74A20402-00DF-4A87-98D1-B5A8920F1D32", "1D0D3794-C210-48A8-8C68-3FBEC08A6BA5", "Results Lava Template", "ResultsLavaTemplate", "Results Lava Template", "The Lava template to show with the results of the search.", 0, "", "5B123108-1C30-4F91-BCA1-1A91561EA07E" );
            RockMigrationHelper.AddOrUpdateBlockTypeAttribute( "74A20402-00DF-4A87-98D1-B5A8920F1D32", "1D0D3794-C210-48A8-8C68-3FBEC08A6BA5", "Results Header Lava Template", "ResultsHeaderLavaTemplate", "Results Header Lava Template", "The Lava Template to use to show the results header.", 0, "", "DF0ADA6D-FF88-4569-957A-EF1509333BF5" );
            RockMigrationHelper.AddOrUpdateBlockTypeAttribute( "74A20402-00DF-4A87-98D1-B5A8920F1D32", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Load Results on Initial Page Load", "LoadResultsOnInitialPageLoad", "Load Results on Initial Page Load", "When enabled the group finder will load with all configured groups (no filters enabled).", 0, "False", "8B41DDE9-5FE8-4BFA-83FB-75869B64F6C3" );
            ...
            RockMigrationHelper.AddOrUpdateBlockTypeAttribute( "74A20402-00DF-4A87-98D1-B5A8920F1D32", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Display Location Sort", "DisplayLocationSort", "Display Location Sort", "Determines if the location sort field should be shown.", 0, "False", "21936ABB-7C05-4752-9D91-E8214B6AEFAD" );
            ...
            RockMigrationHelper.AddOrUpdateBlockTypeAttribute( "74A20402-00DF-4A87-98D1-B5A8920F1D32", "E9C12C59-98EA-4977-8318-647435BE9A9C", "Root Named Schedule", "RootNamedSchedule", "Root Named Schedule", "When displaying the named schedule filter this will serve to filter which named schedules to show. Only direct descendants of this root schedule will be displayed.", 0, "", "C358D22E-473A-4E7E-9E23-47C934D52D7A" );
