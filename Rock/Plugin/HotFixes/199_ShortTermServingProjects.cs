...
namespace Rock.Plugin.HotFixes
{
    ...
    public class ShortTermServingProjects : Migration
    {
        ...
        private void ShortTermServingProjects_AddPublicBlockTypes()
        {
            ...
            RockMigrationHelper.AddOrUpdateBlockTypeAttribute( "74A20402-00DF-4A87-98D1-B5A8920F1D32", "9C204CD0-1233-41C5-818A-C5DA439445AA", "Results Lava Template", "ResultsLavaTemplate", "Results Lava Template", "The Lava template to show with the results of the search.", 0, "", "5B123108-1C30-4F91-BCA1-1A91561EA07E" );
            RockMigrationHelper.AddOrUpdateBlockTypeAttribute( "74A20402-00DF-4A87-98D1-B5A8920F1D32", "9C204CD0-1233-41C5-818A-C5DA439445AA", "Results Header Lava Template", "ResultsHeaderLavaTemplate", "Results Header Lava Template", "The Lava Template to use to show the results header.", 0, "", "DF0ADA6D-FF88-4569-957A-EF1509333BF5" );
