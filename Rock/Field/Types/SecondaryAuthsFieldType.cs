...
namespace Rock.Field.Types
{
    ...
    public class SecondaryAuthsFieldType : FieldType
    {
        ...
        public override Control EditControl( Dictionary<string, ConfigurationValue> configurationValues, string id )
        {
            try
            {
                return new SecondaryAuthsPicker { ID = id };
            }
        ...
        {
            if ( control != null && control is SecondaryAuthsPicker )
            {
                return ( ( SecondaryAuthsPicker ) control ).SelectedValues.AsDelimited( "|" );
            }
            return null;
        }
        ...
        {
            var picker = control as SecondaryAuthsPicker;
            if ( picker != null )
            {
