...
namespace Rock.Security
{
    ...
    public class SecuritySettings
    {
        ...
        public SecuritySettings()
        {
            ...
            PasswordlessSignInDailyIpThrottle = PasswordlessSignInDailyIpThrottleDefaultValue;
            PasswordlessConfirmationCommunicationTemplateGuid = Rock.SystemGuid.SystemCommunication.PASSWORDLESS_SIGN_IN_CODE.AsGuid();
            PasswordlessSignInSessionDuration = PasswordlessSignInSessionDurationDefaultValue;
        }
    }
}
