            ...
            <div class="panel panel-block">
                ...
                <div class="panel-body">
                    <div class="grid grid-panel">
                        ...
                        <Rock:Grid ID="gAttendees" runat="server" DataKeyNames="Id,GroupMemberId" DisplayType="Full" AllowSorting="true" CssClass="js-grid-members" RowItemText="Attendee" OnRowDataBound="gAttendees_RowDataBound" OnGridRebind="gAttendees_GridRebind" OnRowSelected="gAttendees_RowSelected" ExportSource="ColumnOutput">
                            <Columns>
